  ...
  <div class="flex min-h-screen bg-base-200">
    ...
    <main class="flex-1 p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="card shadow-md bg-base-100 p-4 flex flex-col items-center justify-center">
          <h2 class="card-title text-center">Total Books</h2>
          <p class="text-3xl font-bold">{{ booksCount }}</p>
        </div>
        <div class="card shadow-md bg-base-100 p-4 flex flex-col items-center justify-center">
          <h2 class="card-title text-center">Total Authors</h2>
          <p class="text-3xl font-bold">{{ authorsCount }}</p>
        </div>
        <div class="card shadow-md bg-base-100 p-4 flex flex-col items-center justify-center">
          <h2 class="card-title text-center">Top Author</h2>
          <p class="text-lg font-semibold">{{ topAuthor?.name || 'Loading...' }}</p>
        </div>
        <div class="card shadow-md bg-base-100 p-4 flex flex-col items-center justify-center">
          <h2 class="card-title text-center">Top Tag</h2>
